...
class Play extends React.Component {
    ...
    // console.log(this.questions)
        ...
        return (
            <Fragment>
                <Helmet><title>Test quiz</title></Helmet>
                <Fragment>
                ...
                <div className="questions">
                    ...
                    <div className='lifeline-container'> 
                        <p>
                            <span onClick={this.handleFiftyFifty} className="lifeline">Elikka/Ellik: {fiftyFifty}</span>
                        </p>
                        <p>
                            <span onClick={this.handleHints} className="lifeline">variantlarni uchirish: {hints}</span>
                        </p>
                    </div>
                    <div className="timer-container">
                        <p className="timer-number">
                            ...
                            {/*<br></br>*/}
                            <span className="left">{currentQuestionIndex+1} # {numberOfQuestions}</span>
                    ...
                    <div className="button-container">
                        <button className={classNames('', {'disable': this.state.previousButtonDisabled})} id="previous-button" onClick={this.handleButtonClick}>oldinga</button>
                        <button className={classNames('', {'disable': this.state.nextButtonDisabled})} id="next-button" onClick={this.handleButtonClick}>kengisi</button>
                        <button id="quit-button" onClick={this.handleButtonClick}>chiqib ketish</button>
